...
var MasakanList = [
  Masakan(
    ...
    imageUrls: [
      'https://th.bing.com/th/id/OIP.qNWDKaTrWQ4Fur2D8cNgvwHaFS?pid=ImgDet&w=196&h=139&c=7&dpr=1,5',
      'https://img.theculturetrip.com/768x/wp-content/uploads/2018/04/shutterstock_554112613.jpg',
      'https://th.bing.com/th/id/OIP.STcerlq2qfiOgzKFNOhPwgHaHF?pid=ImgDet&w=196&h=187&c=7&dpr=1,5',
      'https://bintaro.co.id/v2/wp-content/uploads/2019/05/Rendang-Uni-Yur.jpg',
    ],
    isFavorite: false,
  ),
  Masakan(
    ...
    description:
    'Pempek, hidangan khas Palembang, Sumatra Selatan, Indonesia, adalah kelezatan unik yang menggabungkan ikan, tepung sagu, dan rempah-rempah dalam satu sajian istimewa. Pempek biasanya terdiri dari adonan yang terbuat dari ikan tenggiri yang dihaluskan, dicampur dengan tepung sagu, dan bumbu-bumbu seperti garam dan lada. Adonan kemudian dibentuk menjadi berbagai bentuk, seperti bulat (kapal selam), pipih (lenjer), atau bulat pipih (adaan). Kemudian, pempek direbus atau dikukus sebelum dipanggang atau digoreng untuk memberikan tekstur yang kenyal dan lembut. Pempek selanjutnya disajikan dengan kuah cuko, saus yang terbuat dari campuran gula aren, cuka, air, bawang putih, dan cabe rawit. Kuah cuko ini memberikan sentuhan asam, manis, dan pedas yang menyatu dengan sempurna, menambahkan dimensi rasa yang kaya pada hidangan. Pempek sering disajikan dengan irisan telur rebus dan tauge sebagai pelengkap. Kelezatan Pempek tidak hanya terletak pada cita rasa yang unik, tetapi juga pada pengalaman kuliner yang menyenangkan, menggabungkan kekenyalan ikan, keharuman rempah, dan sensasi rasa cuko yang memukau.',
    imageAsset: 'images/pempek.jpg',
    imageUrls: [
      'https://media.istockphoto.com/id/1470160209/id/foto/pempek.jpg?b=1&s=612x612&w=0&k=20&c=-MSYffXGEYBw4oM3DY3a6PDjFrE_D_VvHEFoMC98sLY=',
      'https://media.istockphoto.com/id/1361196001/id/foto/makanan-tradisional.jpg?b=1&s=612x612&w=0&k=20&c=y915kUZ59WlnHG8MKG-dlubrK5eCaZIMDSM9BA2PJ2E=',
      'https://media.istockphoto.com/id/1454401323/id/foto/pempek-palembang-traditional-food-from-south-sumatra-indonesia.jpg?b=1&s=612x612&w=0&k=20&c=jMyuJIW9n0BFKz1N1sOvTJEchPfJgsVk3drurlBvnZM=',
      'https://media.istockphoto.com/id/1496078427/id/foto/makanan-indonesia.jpg?b=1&s=612x612&w=0&k=20&c=UrqXu75zmGSPLTGRF5wUx8LvbyOqToFmC_yv9HFRd2Y=',
    ],
    isFavorite: false,
  ),
  Masakan(
    ...
    description:
    'Sate Padang, hidangan yang berasal dari Padang, Sumatra Barat, Indonesia, menggoda selera dengan cita rasa yang kaya, pedas, dan lezat. Hidangan ini terdiri dari potongan-potongan daging, biasanya daging sapi, yang ditusuk kecil-kecil dan dipanggang hingga matang di atas bara api. Namun, keunikan Sate Padang terletak pada kuah kacang khasnya yang sangat lezat. Kuah kacang ini disiapkan dengan mencampurkan bumbu rempah seperti ketumbar, kemiri, cabe merah, bawang merah, dan bawang putih yang dihaluskan, lalu direbus bersama dengan santan kelapa hingga mengental. Selain itu, sate ini juga sering dilengkapi dengan potongan nasi ketan atau lontong, serta irisan bawang merah dan daun seledri sebagai hiasan. Rasa pedas dan gurih kuah kacang Sate Padang menciptakan paduan cita rasa yang menggugah selera, menjadikannya sebagai salah satu hidangan sate yang paling dicari di Indonesia..',
    imageAsset: 'images/satepadang.jpg',
    imageUrls: [
      'https://media.istockphoto.com/id/1337983615/photo/sate-padang.jpg?b=1&s=612x612&w=0&k=20&c=GM-Uwz65eruVuMCaJQG7HTfurhDoMPrrxqUg3UacfSc=',
      'https://media.istockphoto.com/id/1434531397/photo/sate-padang-and-rice-cake.jpg?b=1&s=612x612&w=0&k=20&c=5Ea8Itim2rIxsW2EBwDRQ-R2Cy-g8gw4_YXxVi9Cr_c=',
      'https://media.istockphoto.com/id/1077397088/photo/sate-padang-satay-padang.jpg?b=1&s=612x612&w=0&k=20&c=aOtrmrWf0NMGxjBviQpMMGYsMhGY4Oy0xMg8Zq3v734=',
      'https://media.istockphoto.com/id/1344167197/photo/indonesian-food-sate-padang-or-padang-satay-or-chicken-sate-satay.jpg?b=1&s=612x612&w=0&k=20&c=kL9O8FxxiiJE80cwoSsWNpVQB_3A4J030LguACTlqEs=',
    ],
    isFavorite: false,
  ),
  Masakan(
    ...
    origin: 'Yogyakarta',
    description:
    'Gudeg, sebuah hidangan tradisional dari Yogyakarta, Indonesia, adalah paduan lezat antara nangka muda yang dimasak dalam santan, gula kelapa, dan berbagai rempah-rempah yang khas. Dengan warna coklat kekuningan yang menggoda, Gudeg menyajikan keharuman rempah yang meresap dan rasa manis lembut dari campuran santan dan gula kelapa. Potongan nangka muda yang lunak dan empuk, disertai dengan potongan daging, dimasak dalam kelezatan bumbu-bumbu seperti daun salam, serai, ketumbar, dan kelapa parut. Gudeg umumnya disajikan dengan nasi putih, telur rebus, dan ayam kampung atau abon sebagai pelengkapnya. Keunikan Gudeg terletak pada penyajiannya yang memberikan pengalaman rasa yang seimbang antara manis dan gurih, menjadikannya sebagai salah satu hidangan khas Indonesia yang tak terlupakan.',
    imageAsset: 'images/gudeg.jpg',
    imageUrls: [
      'https://th.bing.com/th?id=OIP.2HfedVk5gpYKca6yNYV3lAHaFj&w=288&h=216&c=8&rs=1&qlt=90&o=6&dpr=1.5&pid=3.1&rm=2',
      'https://www.indonesia.travel/content/dam/indtravelrevamp/en/destinations/revisi-2020/thumbnailgudeg.jpg',
      'https://th.bing.com/th/id/OIP.Zh_ARkagLz4Ub5WQ-zzJ6AHaEK?w=321&h=180&c=7&r=0&o=5&dpr=1.5&pid=1.7',
      'https://th.bing.com/th/id/OIP.Oq7r3AbtbacxNF0fdyw9lAHaE8?w=272&h=181&c=7&r=0&o=5&dpr=1.5&pid=1.7',
    ],
    isFavorite: false,
  ),
  Masakan(
    ...
    description:
    'Rawon adalah hidangan khas Jawa Timur, Indonesia, yang memikat dengan warna hitam pekat dan cita rasa yang khas. Hidangan ini terkenal karena kuahnya yang gurih dan berwarna hitam, yang diperoleh dari penggunaan kluwek, sejenis buah yang memberikan warna dan rasa khas. Potongan daging sapi, sering kali berupa daging empuk seperti tengkleng atau empal, dimasak dalam kuah rawon yang diperkaya dengan rempah-rempah seperti ketumbar, kunyit, lengkuas, dan daun salam. Selain daging, hidangan ini juga dapat mengandung telur asin dan tauge sebagai pelengkap. Rawon biasanya disajikan dengan nasi putih dan dilengkapi dengan sambal terasi, irisan jeruk limau, dan emping sebagai tambahan tekstur. Kelezatan rawon tidak hanya terletak pada cita rasa yang kaya dan unik, tetapi juga pada harmoni antara rempah-rempah dan bumbu-bumbu yang digunakan, menciptakan sebuah pengalaman kuliner yang mendalam dan otentik dari Indonesia..',
    imageAsset: 'images/rawon.jpg',
    imageUrls: [
      'https://thumbs.dreamstime.com/b/rawon-typical-indonesian-food-294453386.jpg',
      'https://thumbs.dreamstime.com/b/rawon-soup-tasty-delicious-rawon-soup-tasty-delicious-175264745.jpg',
      'https://thumbs.dreamstime.com/b/rawon-typical-dish-ponorogo-indonesia-291548892.jpg',
      'https://thumbs.dreamstime.com/z/rawon-indonesian-black-beef-soup-food-photography-served-rice-hard-boiled-egg-bean-sprouts-crackers-155226959.jpg',
    ],
    isFavorite: false,
  ),
  Masakan(
    ...
    imageAsset: 'images/sotobanjar.jpg',
    imageUrls: [
  ...
  Masakan(
    ...
    imageAsset: 'images/cotomakassar.jpg',
    imageUrls: [
  ...
  Masakan(
    ...
    imageAsset: 'images/buburmanado.jpeg',
    imageUrls: [
  ...
  Masakan(
    ...
    imageAsset: 'images/ayamtaliwang.jpg',
    imageUrls: [
